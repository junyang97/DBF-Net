...
class setting_config:
    ...
    if datasets == 'isic18':
        ...
        data_path = '/home/admin123/sjy/xiangmu1/VmTu1/data/PolypSegData/'#/home/admin123/sjy/xiangmu1/VmTu1/data/PolypSegData/
    elif datasets == 'gim':
    ...
    if opt == 'Adadelta':
        ...
        lr = 1e-4 # default: 1e-3 – learning rate###初始0.001保持跟我之前代码1e-5 haishiguo1e-4
        betas = (0.9, 0.999) # default: (0.9, 0.999) – coefficients used for computing running averages of gradient and its square
        eps = 1e-8 # default: 1e-8 – term added to the denominator to improve numerical stability
    ...
    if sch == 'StepLR':
        ...
        T_max = 200 # – Maximum number of iterations. Cosine function period.#######原本50
        eta_min = 1e-6 # – Minimum learning rate. Default: 0.#########0.00001
        last_epoch = -1 # – The index of last epoch. Default: -1.
